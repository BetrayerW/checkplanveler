...
$mail = new PHPMailer();
$mail->IsSMTP();
$mail->Host = "us-cdbr-east-02.cleardb.com"; // Enter your host here
$mail->SMTPAuth = true;
$mail->Username = "planveler@gmail.com"; // Enter your email here
$mail->Password = "planveler123"; //Enter your password here
$mail->Port = 25;
$mail->IsHTML(true);
